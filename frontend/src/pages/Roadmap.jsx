...
function Roadmap() {
  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-12">
      <h2 className="text-3xl font-bold mb-2">Öğrenme Yol Haritası</h2>
      <p className="text-gray-400 mb-8">CV'ndeki eksikleri tespit et, adım adım öğrenme planı oluştur.</p>
      ...
      {result && (
        <div>
          <h3 className="text-xl font-semibold mb-6">
            {result.position} için Öğrenme Yol Haritası
          </h3>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {step.resources.map((r, j) => (
                        <span key={j} className="text-xs bg-gray-800 text-gray-300 px-3 py-1 rounded-full">
                          {r}
                        </span>
                      ))}
                    </div>
